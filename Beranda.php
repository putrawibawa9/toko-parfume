...
<head>
    ...
    <title>GOLDEN PARFUM | BERANDA</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-5 fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand">TOKO PARFUME</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Produk/all-produk.php">Mobil</a>
                    </li>
                </ul>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner shadow-lg ">
                    <div class="carousel-item active mt-4">
                        <img src="icon/goldenparfum.png" class="d-block w-100">
                    </div>
                </div>
