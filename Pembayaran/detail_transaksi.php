...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-5 fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand"><b>GOLDEN PARFUM</b></a>
        </div>
    </nav>
    ...
    <div class="container mt-5">
        ...
        <div class="alert alert-info text-center" role="alert">
            <h4><b>Terima kasih telah berbelanja di GOLDEN PARFUM</b></h4>
            ...
            <h6>Pembayaran di lakukan di luar website, Toko Parfum akan menghubungimu lewat whatsapp</h6>
        ...
        <?php
            ...
            ?>
        <div class="alert alert-info text-center" role="alert">
            <h4><b>Terima kasih telah berbelanja di toko parfum</b></h4>
            <p>Total Harga yang harus anda bayar adalah Rp.
